...
export function NoteCard({note, handleRemoveNote}: NoteCardProps) {
  return (
    <Dialog.Root>
      <Dialog.Trigger
        className="rounded-md text-left flex-col bg-slate-800 p-5 space-y-3 overflow-hidden outline-none
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          w-full md:h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none">
          ...
          <button
            ...
            className="
            w-full bg-slate-800 py-4 text-center text-small text-slate-300 outline-none
            font-medium group"
          >
